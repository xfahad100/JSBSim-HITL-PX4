...
class MavlinkInterface {
 public:
  ...
  void handleHighLatency(mavlink_message_t& message);
  void forward_mavlink_message(const mavlink_message_t *message);
  void output(const mavlink_message_t *motor);
  void open();
  void close();
  void Load();
 ...
 private:
  ...
  void servos(mavlink_message_t *msg);
  ...
  double elevatorDefPWM = 0;
  double aileronDefPWM = 0;
  double rudderDefPWM = 0;
  double throttleDefPWM =0;
  double elevatorDefDeg  = 0;
  double aileronDefDeg = 0;
  double rudderDefDeg  = 0;
  double throttleDef = 0;
